...
parser = argparse.ArgumentParser(description="Hidden shift.")
parser.add_argument('--nqubits', type=int, default=12, help='the number of qubits')
parser.add_argument('--nsamples', type=int, default=100, help='the number of samples')
...
def main(qubit_count=6, sample_count=100, ngpus=1):
    # Set up input qubits.
...
if __name__ == '__main__':
    ...
    main(qubit_count=args.nqubits, sample_count=args.nsamples, ngpus=args.ngpus)
